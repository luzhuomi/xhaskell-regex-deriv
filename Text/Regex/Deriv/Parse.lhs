...
> module Text.Regex.Deriv.Parse (parsePat, parseEPat, parsePatPosix) where
...
> import Text.Regex.Deriv.ExtPattern (EPat(..))
> import Text.Regex.Deriv.IntPattern (Pat(..))
> import Text.Regex.Deriv.RE (RE(..))
> import Text.Regex.Deriv.Translate (translate, translatePosix) 
